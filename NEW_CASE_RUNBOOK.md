...
cp -r /Users/richconnelly/ironcladjustice-deploy/CASE_TEMPLATE \
      /Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}
```
...
Open `/Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}/index.html` and replace every `[BRACKET]` placeholder:
...
```bash
grep -n "\[" /Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}/index.html
```
...
cp /path/to/your/image.jpg \
   /Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}/images/[CASE_IMAGE_FILENAME]
```
...
```bash
open /Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}/index.html
```
...
```bash
cd /Users/richconnelly/ironcladjustice-deploy/ironcladjustice-${CASE}
...
Open `/Users/richconnelly/ironcladjustice-deploy/index.html` and add the new case to the case cards section. Follow the same pattern as the existing talcum/hair/depo cards.

Then deploy the homepage update:

```bash
cd /Users/richconnelly/ironcladjustice-deploy
git add index.html
